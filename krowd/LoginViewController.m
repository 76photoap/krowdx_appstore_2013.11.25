...
- (void)viewDidLoad
{
    ...
    activityIndicator.frame = CGRectMake(screenSize.width/2-activityIndicator.frame.size.width/2, screenSize.height/2-activityIndicator.frame.size.height/2, activityIndicator.frame.size.width, activityIndicator.frame.size.height);
